...
# §9.3.4 Strings
def EncodeString(value: str, encoding: int = constant.ENC_ISO_8859_1) -> bytearray:
    return bytearray(value + constant.LATIN_ST, constant.PY_ENCODING[encoding])
...
def EncodeCommand : pass

false = b'\x80'    # <INTEGER: 0> coded by byte value 128
true  = b'\x81'    # <INTEGER: 1> coded by byte value 129
